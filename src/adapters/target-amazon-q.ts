// src/adapters/target-amazon-q.ts
...
export const targetAmazonQ: TargetAdapter = {
  toolId: 'amazon-q',
  label: 'Amazon Q',
  defaultPath: '~/.aws/q-developer/',
  ...
  write(entries: MemoryEntry[], basePath: string): MigrationResult {
    ...
    try {
      ...
      result.errors.push(`Failed to write Amazon Q memories: ${err}`);
    }
