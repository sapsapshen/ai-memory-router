// src/adapters/target-windsurf.ts
...
export const targetWindsurf: TargetAdapter = {
  toolId: 'windsurf',
  label: 'Windsurf',
  defaultPath: '~/.codeium/windsurf/',
  ...
  write(entries: MemoryEntry[], basePath: string): MigrationResult {
    ...
    try {
      ...
      result.errors.push(`Failed to write Windsurf memories: ${err}`);
    }
